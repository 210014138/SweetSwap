...
<div class="quiz-container">
        ...
        <ul class="quiz-list">
            ...
            <div class="quiz">
                ...
                <button class="start-button"><a href="sweet_tooth_trivia.php">Start</button></a>
            </div>
            <div class="quiz">
                <div class="points-badge">+20</div> 
                ...
                <button class="start-button"><a href="sweetness_showdown.php">Start</button></a>
            </div>
            <div class="quiz">
                <div class="points-badge">+20</div> 
                ...
                <button class="start-button"><a href="sugar_rush_riddles.php">Start</button></a>
            </div>
            <div class="quiz">
                <div class="points-badge">+20</div> 
                ...
                <button class="start-button"><a href="sugar_free_challenge.php">Start</button></a>
            </div>
            <div class="quiz">
                <div class="points-badge">+20</div> 
                ...
                <button class="start-button"><a href="sweet_swap_challenge.php">Start</button></a>
            </div>
            <div class="quiz">
                ...
                <button class="start-button"><a href="detox.php">Start</button></a>
            </div>
